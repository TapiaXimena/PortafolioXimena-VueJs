<script setup>
import img1 from '/src/components/icons/pseint.svg';
import img2 from '/src/components/icons/python.svg';
import img3 from '/src/components/icons/java.svg';
import img4 from '/src/components/icons/html-css.svg';
import img5 from '/src/components/icons/js.svg';
import img6 from '/src/components/icons/bootstrap.svg';
import img7 from '/src/components/icons/vue.svg';
import img8 from '/src/components/icons/react.svg';
import img9 from '/src/components/icons/git.svg';
import img10 from '/src/components/icons/visual.svg';
import img11 from '/src/components/icons/figma.svg';
import img12 from '/src/components/icons/drive.svg';
import img13 from '/src/components/icons/mysql.svg';
import img14 from '/src/components/icons/sql.svg';
import img15 from '/src/components/icons/arg.svg';
import img16 from '/src/components/icons/eeuu.svg';
...
const habilidades = ref([
    {// Se crea un objeto con id, nombre y habilidades
        id: 1, nombre: 'Lenguajes de Programación', habilidades: [
            ...
            { id: 1, nombre: 'PSeint', nivel: 'Intermedio', icono: img1 },
            { id: 2, nombre: 'Python', nivel: 'Intermedio', icono: img2 },
            { id: 3, nombre: 'Java', nivel: 'Básico', icono: img3 },
            { id: 4, nombre: 'HTML/CSS', nivel: 'Intermedio', icono: img4 },
            { id: 5, nombre: 'JavaScript', nivel: 'Básico', icono: img5 },
        ]
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            { id: 1, nombre: 'Bootstrap', nivel: 'Básico', icono: img6 },
            { id: 2, nombre: 'Vue.js', nivel: 'Aprendiendo', icono: img7 },
            { id: 5, nombre: 'React.js', nivel: 'En proceso de aprendizaje', icono: img8 },
        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'Git y GitHub', nivel: 'Intermedio', icono: img9 },
            { id: 2, nombre: 'Visual Studio Code', nivel: 'Intermedio', icono: img10 },
            { id: 2, nombre: 'Canva y Figma', nivel: 'Intermedio', icono: img11 },
            { id: 5, nombre: 'Google Drive', nivel: 'Intermedio', icono: img12 },
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 2, nombre: 'MySQL', nivel: 'Básico', icono: img13 },
            { id: 2, nombre: 'SQLite', nivel: 'Básico', icono: img14 },
        ]
    },
    {
        id: 5, nombre: 'Idiomas', habilidades: [
            { id: 1, nombre: 'Español', nivel: 'Nativo', icono: img15 },
            { id: 2, nombre: 'Inglés', nivel: 'Básico', icono: img16 },
        ]
    }
]);
...
.skills-contenedor {
    ...
    /*Fondo con gradiente*/
    background: linear-gradient(-45deg,#2C0F4B,#4A1E8C,#7A5FD4,#320269);
