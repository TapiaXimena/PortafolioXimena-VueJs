...
fechaColor.value = [
{color: '#6AC1FF'}, // azul cielo, contraste suave
{color: '#00FFD6'}, // turquesa brillante, fresco
{color: '#7F5AF0'}, // violeta medio, armoniza con el fondo
{color: '#3E8EDE'}, // azul eléctrico, resalta sin chocar
{color: '#4ED8A5'}  // verde agua, frío y suave
];
/*Esta es la forma de utilizar el arreglo, sin el metodo value*/
const educacion = ref([
  {fecha: '2025', title: 'Tecnicatura Universitaria en Programación', descripcion: 'Actualmente cursando en la UTN - Facultad Regional San Rafael, Mendoza. Durante la carrera aprendo fundamentos de programación, lógica, algoritmos, bases de datos, y desarrollo de sistemas. Trabajo con lenguajes como Python, Java y JavaScript, aplicando conceptos de arquitectura y sistemas operativos.', enlace:'ver más'},
  {fecha: '2024', title: 'Curso de Introducción al Desarrollo Web', descripcion: 'Realizado de forma online, donde adquirí conocimientos básicos de HTML, CSS y JavaScript para la creación de sitios web sencillos y responsivos.', enlace:'ver más'},
  {fecha: '2023', title: 'Proyecto Personal - Calculadora Interactiva', descripcion: 'Desarrollé una calculadora en línea utilizando HTML, CSS y JavaScript. Este proyecto me permitió reforzar conceptos sobre lógica de programación y manejo del DOM.', enlace:'ver más'},
  {fecha: '2022', title: 'Curso de Ofimática y Herramientas Digitales', descripcion: 'Completé un curso práctico sobre manejo de programas como Word, Excel y PowerPoint, y herramientas colaborativas como Google Drive y Canva.', enlace:'ver más'},
  {fecha: '2021', title: 'Curso de Introducción a la Programación con PSeInt', descripcion: 'Aprendí los conceptos básicos de la programación estructurada, variables, estructuras condicionales y repetitivas, desarrollando pequeños algoritmos paso a paso.', enlace:'ver más'}
]);
</script>
