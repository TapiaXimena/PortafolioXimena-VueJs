<script setup>
import proyecto1 from '/src/assets/gestione.png';
import proyecto2 from '/src/assets/hotel.png';
import proyecto3 from '/src/assets/portafoliop.png';
import proyecto4 from '/src/assets/juegoadiv.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Sistema de Gestión de Estudiantes (2025)",
        descripcion: "Desarrollé un pequeño sistema de gestión académica como práctica para la materia de Programación. Permite registrar alumnos, mostrar notas y realizar búsquedas básicas. Lo implementé utilizando Python y estructuras de datos simples.",
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Página Web de Reservas de Hotel (2024)",
        descripcion: "Creé una simulación de sistema de reservas de hotel con formularios interactivos usando HTML, CSS y JavaScript. El proyecto muestra mensajes personalizados al enviar formularios y utiliza un diseño responsive.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Portafolio Personal (2024)",
        descripcion: "Diseñé y programé mi portafolio web como parte de mis prácticas. Incluye secciones sobre mi formación, experiencia y proyectos, componentes, scripts, estilos, formularios, menús y enlaces, y está desarrollado con HTML, CSS y un poco de JavaScript.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Juego de Adivinanza en Python (2023)",
        descripcion: "Desarrollé un juego que genera un número aleatorio y desafía al usuario a adivinarlo. El juego indica si el número ingresado es mayor o menor que el objetivo, fomentando la práctica de la lógica y la resolución de problemas de manera interactiva.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
])
...
.galeria {
    ...
    background: linear-gradient(-45deg,#2C0F4B,#4A1E8C,#7A5FD4,#9BB7E4);
